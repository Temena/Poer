...
{	
	...
	public void create() {
		...
		FlxG.playMusic("Destination.mp3", 1f, true, true);
		health = 4;
		hurtWait = 0;
		level = new FlxTilemap();
		level.loadMap(FlxTilemap.arrayToCSV(new IntArray(data), 50), "map.png", 16, 16);
		add(level);
		...
		//add(enemy);
		add(pad);
		add(new FlxText(40, 115, 200, "Press A to jump over obstacles"));
		add(new FlxText(240, 160, 200, "Enter portals to continue"));
	}
